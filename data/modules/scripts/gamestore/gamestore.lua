...
GameStore.Categories = {
	...
	-- Cosmetics ~ Mounts
	{
		...
		offers = {
			...
			},
			{
				...
				price = 375,
				id = 216,
				description = "{character}\n{speedboost}\n\n<i>Born from the fire, where burn mysterious ways.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
				home = true,
			},
			{
			...
			{
				icons = { "Singein_steed.png" },
				name = "Singein Steed",
				price = 1500,
				id = 184,
				description = "{character}\n{speedboost}\n\n<i>Singeing Steed will be yours!.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				icons = { "Zaoan_Badger.png" },
				...
				price = 1500,
				id = 218,
				description = "{character}\n{speedboost}\n\n<i>Spirit of Purity will be yours.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
		},
	},   
	...
	-- Set Itens
	{
		...
		name = "Items",
		rookgaard = true,
		subclasses = {"Destruction", "Tools", "Protections"},
	},
	-- Destruction
	{
	icons = { "Category_ExclusiveOffers.png" },
		...
		offers = {
			{
				...
				name = "mysthera warbag",
				price = 1000,
				itemtype = 44613,
				charges = 1,
				description = "Extra regeneration, all protection +2.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
			},
			{
				icons = { "Blessed_Wooden_Stake.png" },
				name = "mysthera small backpack",
				price = 1000,
				itemtype = 44618,
				charges = 1,
				description = "Extra regeneration, all protection +2.",
	...
	icons = { "Category_ExclusiveOffers.png" },
		...
		offers = {
			{
				icons = { "major_crystalline_token.png" },
				name = "Major Crystalline Token",
				price = 50,
				itemtype = 16129,
				count = 10,
				description = "Can be traded for outfit items, equipment and some other items with Gnomally.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
				movable = true,
			},
			{
			...
			},
			{
				...
				name = "The Supreme Cube",
				price = 25,
				itemtype = 31633,
				charges = 1,
				description = "It's black and it's supreme.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
			},
			{
			...
			{
				icons = { "abriged_promotion_scroll.png" },
				name = "abridged promotion scroll",
				price = 20,
				itemtype = 43946,
				charges = 1,
				description = "decipher this scroll to gain 3 promotion points for the Wheel of Destiny. Only one per character",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
			},
			{
				icons = { "basic_promotion_scroll.png" },
				name = "basic promotion scroll",
				price = 40,
				itemtype = 43947,
				charges = 1,
				description = "decipher this scroll to gain 5 promotion points for the Wheel of Destiny. Only one per character",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
			},
			{
				icons = { "revised_promotion_scroll.png" },
				name = "revised promotion scroll",
				price = 60,
				itemtype = 43948,
				charges = 1,
				description = "decipher this scroll to gain 9 promotion points for the Wheel of Destiny. Only one per character",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
			},
			{
				icons = { "extended_promotion_scroll.png" },
				name = "extended promotion scroll",
				price = 80,
				itemtype = 43949,
				charges = 1,
				description = "decipher this scroll to gain 13 promotion points for the Wheel of Destiny. Only one per character",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
			},
			{
				icons = { "advanced_promotion_scroll.png" },
				name = "advanced promotion scroll",
				price = 100,
				itemtype = 43950,
				charges = 1,
				description = "decipher this scroll to gain 20 promotion points for the Wheel of Destiny. Only one per character",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
			},
			{
				icons = { "advanced_promotion_scroll.png" },
				name = "upgrade sanguine",
				price = 1000,
				itemtype = 44008,
				charges = 1,
				description = "use with a sanguine item to upgrade it",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
			},
		...
		offers = {
			{
				...
				itemtype = 43863,
				charges = 1,
				description = "(protection ice +2%)It was made from a conch shell and shimmers in the colour of the moon.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
			},
			{
				...
				itemtype = 43740,
				charges = 1,
				description = "(protection earth +2%)This nifty gadget can be used for many vital and less vital purposes. If it's not jammed, that is.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
			},
			{
				...
				itemtype = 25975,
				charges = 1,
				description = "(protection death +5%) It weighs 2.00 oz.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
			},
			{
				...
				itemtype = 25977,
				charges = 1,
				description = "(protection fire +5%) It weighs 2.00 oz.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
			},
			{
				...
				itemtype = 25976,
				charges = 1,
				description = "(protection manadrain +5%) It weighs 2.00 oz.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
			},
			{
				...
				itemtype = 34016,
				charges = 1,
				description = "(protection holy +2%)It weighs 5.00 oz. It sparkles slightly",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
			},
		},
	...
	--Offers
	{
		...
		name = "Offers",
		rookgaard = true,
		subclasses = { "Tokens", "Exclusive Offers", "Bundle" },
	},
	--bundle
	{
		...
		offers = {
			{
				...
				sexId = { female = 471, male = 472 },
				addon = 3,
				type = GameStore.OfferTypes.OFFER_TYPE_BUNDLE, -- Define la oferta como tipo Bundle
				items = {
                {
                    icons = { "Outfit_Entrepreneur_Male_Addon_3.png", "Outfit_Entrepreneur_Female_Addon_3.png" },
                    name = "Full Entrepreneur Outfit",
                    ...
                    sexId = { female = 471, male = 472 },
                    addon = 3,
                    description = "{character}\n{info} colors can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Slaughter through hordes of monsters during your early morning hunt and kiss the hand of Queen Eloise later on at the evening reception in her historical residence. With the Entrepreneur outfit you will cut a fine figure on every occasion.</i>",
                    type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
                    id = 146,
                },
                {
		...
		offers = {
			{
				...
				itemtype = 3043,
				count = 100,
				description = "(one million of gold",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
				movable = true,
			},
			{
				...
				itemtype = 44601,
				count = 1,
				description = "(Roulette token, try your luck and win amazing prizes in the roulette",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
				movable = true,
			},
			{
			...
			},
			{
				...
				itemtype = 22721,
				count = 10,
				description = "(Gold token, It can be exchanged with Yana for various weapons and for Creature Products that can be used to imbue them",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
				movable = true,
			},
			{
				...
				itemtype = 22721,
				count = 100,
				description = "(Roulette token, It can be exchanged with Yana for various weapons and for Creature Products that can be used to imbue them",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
				movable = true,
			},
			{
				...
				itemtype = 22516,
				count = 10,
				description = "(Silver token, Can be exchanged with Cledwyn for various armors providing both a skill and a resistance bonus and also for the first and second addons of the Rift Warrior Outfits",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
				movable = true,
			},
			{
	...
	-- Exclusive Offers
	{
		...
		offers = {
			...
			{
				icons = { "Falconer_Male_Addon_3.png", "Falconer_Female_Addon_3.png" },
