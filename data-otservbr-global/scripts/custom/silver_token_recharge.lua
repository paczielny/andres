local config = {
	...
	rechargeables = {
		...
		[39179] = {newItem = 39177, cost = 5}, -- spirithorn ring
		[39182] = {newItem = 39180, cost = 5}, -- alicorn ring
		[39185] = {newItem = 39183, cost = 5}, -- arcanomancer sigil
		[39188] = {newItem = 39187, cost = 5}, -- arboreal sigil
		[39235] = {newItem = 39233, cost = 5}  -- turtle amulet
	}
}
...
function recharging.onUse(player, item)
	...
	for i, info in pairs(config.rechargeables) do
		if player:getItemCount(i) > 0 then
			found = true
			menu:addChoice(string.format("%s", ItemType(i):getName():capitalize()), function (player, button, choice)
